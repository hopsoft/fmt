      ...
      def test_peers_and_nested
        ...
        assert_pattern {
          template = {
            ast: {
              node: Node,
              deflated: "(template (pipeline (macro (name :red))) (embeds (embed (name \"embed_0_0\") (placeholder \"%{embed_0_0}\") (embeds (embed (name \"embed_1_0\") (placeholder \"{{embed_1_0}}\") (embeds (embed (name \"embed_2_0\") (placeholder \"{{embed_2_0}}\")))))) (embed (name \"embed_0_1\") (placeholder \"{{embed_0_1}}\"))))"
            },
            ...
            pipeline: {
              ast: {
                node: Node,
                deflated: "(pipeline (macro (name :red)))"
              },
              urtext: "<one>red",
              source: "<one>red",
              macros: [
